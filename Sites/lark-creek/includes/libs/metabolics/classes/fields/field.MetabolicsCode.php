<?php
/**
 * A text-based field that accepts HTML and is formatted for code
 * 
 ...
 * @since  2.0
 */
class MetabolicsCode extends MetabolicsField {
  ...
  public function output( $saved = NULL ) {
    echo "<textarea class='widefat metabolics-code'
  ...
  public function sanitize( $post_id, $post_data = NULL ) {
    if ( current_user_can( 'unfiltered_html' ) )
      $value = isset( $post_data ) ? $post_data : NULL;
    else
